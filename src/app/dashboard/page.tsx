  ...
  return (
    <main className="flex-1 p-4 sm:p-6">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Here&apos;s a quick overview of your application&apos;s status.</p>
      </div>
      {isServiceAccountMissing && (
        <Alert variant="destructive" className="mb-6">
          ...
          <AlertDescription>
            Variabel lingkungan `FIREBASE_SERVICE_ACCOUNT_KEY` tidak diatur. Beberapa fitur, seperti menampilkan data
            dasbor nyata dan daftar pengguna, tidak akan berfungsi dengan benar. Silakan atur variabel lingkungan untuk
            mengaktifkan fungsionalitas penuh.
          </AlertDescription>
        </Alert>
      )}
